...
class DummyContentGeneratorAction
{
    ...
    {
        $samples = [
            'en' => 'Capell demo content is written to exercise real publishing surfaces: reusable sections, structured summaries, layout widgets, and editorial workflows. It gives teams practical copy that can be reviewed without relying on placeholder filler.',
